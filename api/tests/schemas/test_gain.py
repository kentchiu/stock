...
def test_symbol_gain():
    ...
    total_shares = (trade_apple_1.shares - (trade_apple_1.take or 0)) + (
        trade_apple_2.shares - (trade_apple_2.take or 0)
    )
    trad1_cost = (trade_apple_1.shares - (trade_apple_1.take or 0)) * trade_apple_1.cost
    trad2_cost = (trade_apple_2.shares - (trade_apple_2.take or 0)) * trade_apple_2.cost
...
# TODO test trade.symbol != quote.symbol
